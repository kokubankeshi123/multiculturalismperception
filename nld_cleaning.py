...
rawhand = codecs.open('nld_rawtext.txt', 'r', encoding = 'utf-8')
cleanhand = codecs.open('nld_cleantext.txt', 'w', encoding = 'utf-8')
...
key1 = u'Multiculturalisme'
key2 = u'multiculturalisme'
